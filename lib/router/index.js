...
/**
 * Contains all handlers registred by the router instance
 * @type {Array}
 * @private
 */
let handlers = []
...
module.exports = {
  ...
  /**
   * Passes the request through a series of corresponding middlwares
   * 
   * @param  {Request} req
   * @param  {Response} res
   */
  resolve: function(req, res) {
    ...
    // to the end of the handlers array
...
/**
 * Parse parameters fo dynamic routes
 * @example
